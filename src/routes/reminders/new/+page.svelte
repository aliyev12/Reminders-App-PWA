		...
		<div>
			...
			<div class="relative">
				<input
					...
					id="date"
					name="date"
					class="block w-full rounded-lg border px-4 py-2.5 focus:border-blue-500 focus:ring-blue-500
                                sm:py-3 sm:text-sm
                                {$errors.date
						? 'border-red-500 focus:border-red-500 focus:ring-red-500'
						: 'border-gray-300 dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-400'}"
